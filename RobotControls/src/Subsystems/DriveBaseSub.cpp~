...
DriveBaseSub::DriveBaseSub() : frc::Subsystem("DriveBaseSub") {
    ...
    frontLeftSC = RobotMap::driveBaseSubFrontLeftSC;
    frontRightSC = RobotMap::driveBaseSubFrontRightSC;
    backLeftSC = RobotMap::driveBaseSubBackLeftSC;
    backRightSC = RobotMap::driveBaseSubBackRightSC;
